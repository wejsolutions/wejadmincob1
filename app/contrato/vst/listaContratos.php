			...
			<tbody>
				<?php foreach($row as $r): ?>
					<tr>
						...
						<td align="right" ><?php echo $r->contrato_monto ?></td> // revisar
						...
						<td>
							<div class="btn-group">
								...
								<button class="btn btn-success btn-xs" title="Cuotas" onclick="modal('vst-contrato-listaCuotas','contrato_ide=<?php echo $r->contrato_ide ?>&contrato_cod=<?php echo $r->contrato_codigo ?>')">
									<i class="fa fa-edit"></i>
								</button>																
							</div>
						</td>
