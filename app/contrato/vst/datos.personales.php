			...
			<div class="widget-main">
				...
				<div class="col-sm-10">
					...
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-primary" onclick="load('vst-contrato-update','clien_ide=<?php echo $row[0]->clien_ide ?>','.perfil')"><i class="fa fa-edit"></i> Editar Datos</button>
						<!--<button type="button" class="btn btn-purple" onclick="load('vst-contrato-','clien_ide=<?php echo $row[0]->clien_ide ?>','.perfil')"><i class="fa fa-info"></i> Ver Detalles</button>-->
						<button type="button" class="btn btn-danger" onclick="modal('vst-contrato-delete','clien_ide=<?php echo $row[0]->clien_ide ?>')"><i class="fa fa-trash"></i> Borrar</button>
					</div>
				</div>
