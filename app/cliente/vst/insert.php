...
<div class="alert alert-info">
	<i class="fa fa-exclamation-triangle fa-3x pull-left red"></i> Por favor rellene el siguiente formulario para agregar un cliente | proveedor | vendedor.
</div>
		...
		$(formulario).validate({
			...
			submitHandler: function (form) {
				$.post('prc-mcliente-insert',$(formulario).serialize(),function(data){
					...
					if(!isNaN(data)) {
						alert('Cliente incluido correctamente. Valor de Data: '+data.trim());
