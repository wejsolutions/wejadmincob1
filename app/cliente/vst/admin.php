...
<form action="" class="op0" method="POST">
	<div class="form-group">
		<label for="" class="label control-label col-sm-12 bolder">Buscar Cliente | Proveedor | Vendedor:</label>
		<div class="col-sm-9">
			...
			submitHandler: function (form) {
				$.post('prc-ccliente-buscar',$(formulario).serialize(),function(data){
					if(data.trim()=='no') {
						...
						load('vst-clientecuenta-lista','clien_ide='+data.trim(),'.cuentas');
					}
				})
			},
