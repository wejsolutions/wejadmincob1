<?php class mFacturacion10 {
	...
	public function insertfact() {
		...
		foreach($rowdf as &$rdf){ 
			...
			$datos1 = array(0,$idefactura,$rdf->factdetatemp_produc,$rdf->factdetatemp_producdeta,$rdf->factdetatemp_cant,$rdf->factdetatemp_base,$piva,$monto_iva,$rdf->factdetatemp_precio,$rdf->factdetatemp_monto,1,$_SESSION['s_clien_ide']);
