							...
							<tr>
								...
								<td colspan="3"><?php if ($row[0]->clien_contriespec==0) echo 'NO'; else echo 'SI'; ?>
									<div class="btn-group pull-right">
										<button type="button" class="btn btn-primary" onclick="load('vst-compra-updatecli','clien_ide=<?php echo $row[0]->clien_ide ?>','.perfil')"><i class="fa fa-edit"></i> Modificar</button>
									</div>
								</td>
							</tr>
						</table>
